    ...
    useEffect(()=>{
        if (location.pathname === '/'){
            setFaqData([
                ...
                {id:3,title:'Какую выгоду мне даст франшиза?',text:"- Масштабирование бизнеса и его расширение в регионах и на международном уровне при минимальных затратах;\n" +
                        "- Минимизация рисков. 85% вновь образованных предприятий прекращают свою деятельность в течение первых пяти лет, в рамках франчайзинга этот показатель снижается до 14%.\n" +
                        "- Популяризация бренда и его узнаваемость. Франчайзинговая бизнес-модель предполагает расширение компании, увеличение количества франшизных точек обеспечивает рост узнаваемости бренда всей компании.\n" +
                        "- Постоянный доход. Франчайзинг позволяет получить франчайзеру дополнительный доход для развития бизнеса, он складывается из двух составляющих: первоначальный взнос (паушальный платеж) и регулярные ежемесячные платежи (роялти).  "},
                {id:4,title:'Как продавать франшизу?',text:"Мы рекомендуем нанять менеджера для продвижения и продажи франшизы. Команда Scaleup также предлагает своим клиента разместить актуальную информацию на торговой площадке https://marketplace.scaleup.plus, которая помогает владельцам франшизы и потенциальным покупателям находить друг друга для взаимовыгодного партнерства."},
