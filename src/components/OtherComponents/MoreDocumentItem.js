                                        ...
                                        {docsData[key].data[key2].data[key3].type == 'file' ? (
                                            <div onClick={()=>{
                                                ...
                                                <div className={styles.doc_svg_leftside}>
                                                    <>
                                                        {docsData[key].data[key2].data[key3].name.substring(docsData[key].data[key2].data[key3].name.length-5).toLowerCase().includes('docx') && (
                                                            <WordIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].name.substring(docsData[key].data[key2].data[key3].name.length-5).toLowerCase().includes('pdf') && (
                                                            <PdfIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].name.substring(docsData[key].data[key2].data[key3].name.length-5).toLowerCase().includes('xls') && (
                                                            <XlsIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].name.substring(docsData[key].data[key2].data[key3].name.length-5).toLowerCase().includes('pptx') && (
                                                            <PptxIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].name.substring(docsData[key].data[key2].data[key3].name.length-5).toLowerCase().includes('pdf') && (
                                                            <PdfIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].name.substring(docsData[key].data[key2].data[key3].name.length-5).toLowerCase().includes('png') && (
                                                            <PngIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].name.substring(docsData[key].data[key2].data[key3].name.length-5).toLowerCase().includes('jpg') && (
                                                            <JpgIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].name.substring(docsData[key].data[key2].data[key3].name.length-5).toLowerCase().includes('jpeg') && (
                                                            <JpgIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].name.substring(docsData[key].data[key2].data[key3].name.length-5).toLowerCase().includes('gif') && (
                                                            <GifIcon/>
                                                        )}
                                                    </>
                                                </div>
