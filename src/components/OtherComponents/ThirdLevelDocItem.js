                                        ...
                                        {name2 == key3 && docsData[key].data[key2].data[key3].data && Object.keys(docsData[key].data[key2].data[key3].data)?.map((key4, index) => (
                                            <div
                                                ...
                                                <div className={styles.doc_svg_leftside}>
                                                    <>
                                                        {docsData[key].data[key2].data[key3].data[key4].name.substring(docsData[key].data[key2].data[key3].data[key4].name.length-5).toLowerCase().includes('docx') && (
                                                        <WordIcon/>
                                                    )}
                                                        {docsData[key].data[key2].data[key3].data[key4].name.substring(docsData[key].data[key2].data[key3].data[key4].name.length-5).toLowerCase().includes('pdf') && (
                                                            <PdfIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].data[key4].name.substring(docsData[key].data[key2].data[key3].data[key4].name.length-5).toLowerCase().includes('xls') && (
                                                            <XlsIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].data[key4].name.substring(docsData[key].data[key2].data[key3].data[key4].name.length-5).toLowerCase().includes('pptx') && (
                                                            <PptxIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].data[key4].name.substring(docsData[key].data[key2].data[key3].data[key4].name.length-5).toLowerCase().includes('pdf') && (
                                                            <PdfIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].data[key4].name.substring(docsData[key].data[key2].data[key3].data[key4].name.length-5).toLowerCase().includes('png') && (
                                                            <PngIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].data[key4].name.substring(docsData[key].data[key2].data[key3].data[key4].name.length-5).toLowerCase().includes('jpg') && (
                                                            <JpgIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].data[key4].name.substring(docsData[key].data[key2].data[key3].data[key4].name.length-5).toLowerCase().includes('jpeg') && (
                                                            <JpgIcon/>
                                                        )}
                                                        {docsData[key].data[key2].data[key3].data[key4].name.substring(docsData[key].data[key2].data[key3].data[key4].name.length-5).toLowerCase().includes('gif') && (
                                                            <GifIcon/>
                                                        )}
                                                    </>
                                                </div>
